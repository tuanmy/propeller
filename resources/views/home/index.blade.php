 ...
 <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
          <div class="statistic-box">
            ...
            <p>
              You have two evetns with incomplete tasks.
            </p>
            <div class="row text-center">
              <div class="col-lg-6">
                <canvas id="polarChart" width="80" height="80"></canvas>
                <h5>School Auction</h5>
              </div>
              <div class="col-lg-6">
                <canvas id="doughnutChart" width="78" height="78"></canvas>
                <h5>Grandparent's Day</h5>
              </div>
            </div>
            <div class="m-t">
              <small>The above charts report based on current data in Propeller Seeds.</small>
            </div>
                  ...
                  <div class="ibox-content">
                    ...
                    <div>
                      <div class="feed-activity-list">
                        ...
                        <div class="feed-element">
                          <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="images/demo/a2.jpg">
                          </a>
                          <div class="media-body ">
                        ...
                        <div class="feed-element">
                          <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="images/demo/a3.jpg">
                          </a>
                          <div class="media-body ">
                            <small class="pull-right">2h ago</small>
                        ...
                        <div class="feed-element">
                          <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="images/demo/a5.jpg">
                          </a>
                          <div class="media-body ">
                            <small class="pull-right">2h ago</small>
